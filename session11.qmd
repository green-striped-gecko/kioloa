...
switch(Sys.info()[['sysname']],
       Windows= {
         path.plink <- "./binaries/winbinaries"
         path.colony <- "./binaries/winbinaries/Colony2.msi"
         path.gcta <- "./binaries/winbinaries/gcta64.exe"
         path.EMIBD9 <- "./binaries/winbinaries"
         },
       Linux  = {
         path.plink <- "./binaries/"
         path.colony <- "./binaries/colony2s.gnu.out"
         path.gcta <- "./binaries/gcta64"
         path.EMIBD9 <- "./binaries/"
         },
       Darwin = {
         path.plink <- "./binaries/macbinaries"
         path.colony <- "./binaries/macbinaries/colony2s.out"
         path.gcta <- "./binaries/macbinaries/gcta64"
         path.EMIBD9 <- "./binaries/macbinaries"
         })
```
...
We will use [Diana Robledo's](https://doi.org/10.1111/1755-0998.13844) function to convert a genlight object into COLONY format.
...
coan_col <- readRDS('./data/session11_coan_col.rds')
EMIBD9_col <- readRDS('./data/session11_EMIBD9_col.rds')
GCTA_col <- readRDS('./data/session11_GCTA_col.rds')
GRM_col <- readRDS('./data/session11_GRM_col.rds')
...
```{r, include=FALSE}
analysis_coancestry_2 <- readRDS('./data/session11_analysis_coancestry_2.rds')
