...
For a detailed rundown of the genetic data used by the `dartRverse`, check out the tuturial on **Data Structure and Input** found in the [dartR Tutorials](tutorials.qmd) section.
...
![](images/task.png){.class width="48" height="48"}This quiz is refering to the `testset.gl` dataset you have interrogated above.
...
```{r, eval = FALSE}
gl <- possums.gl # data from dartR.data
...
And check out this interesting paper, @jaya_population_2022.
